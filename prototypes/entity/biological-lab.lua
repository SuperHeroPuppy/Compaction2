data:extend {
  {
    ...
    name = "biological-lab",
    icon = "__Compaction2__/graphics/entity/icons/biological-lab.png",
    ...
    fluid_boxes = {
      {
        ...
        base_level = -1,
        volume = 1000,
        pipe_connections = { { flow_directio = "input", position = { 0, 3 }, direction = defines.direction.south } },
      },
      {
        ...
        base_level = 1,
        volume = 100000,
        pipe_connections = { { flow_directio = "output", position = { 0, -3 }, direction = defines.direction.north } },
      },
    },
