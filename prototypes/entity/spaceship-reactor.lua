...
data:extend({
  {
    ...
    icon = "__Compaction2__/graphics/entity/icons/spaceship-reactor.png",
    ...
    animation = {
      layers = {
        {
          filename = "__Compaction2__/graphics/entity/spaceship-reactor/spaceship-reactor.png",
          width = 286,
          height = 252,
          frame_count = 5,
          line_length = 5,
        ...
        {
          filename = "__Compaction2__/graphics/entity/spaceship-reactor/spaceship-reactor-beams.png",
          width = 224,
          height = 232,
          frame_count = 16,
          line_length = 4,
        ...
        {
          filename = "__Compaction2__/graphics/entity/spaceship-reactor/spaceship-reactor-beams-light.png",
          width = 224,
          height = 232,
          frame_count = 16,
          line_length = 4,
        ...
        {
          filename = "__Compaction2__/graphics/entity/spaceship-reactor/spaceship-reactor-shadow.png",
          width = 474,
          height = 152,
          frame_count = 1,
          line_length = 1,
    ...
    integration_patch = {
      filename = "__Compaction2__/graphics/entity/spaceship-reactor/spaceship-reactor-ground.png",
      width = 384,
      height = 360,
