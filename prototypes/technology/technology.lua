...
data:extend({
    ...
    {
        type = "technology",
        name = "contained-uranium-tech",
        icon = "__Compaction2__/graphics/icons/contained-uranium.png",
        localised_description = "I don't know why I added this, for fun maybe? no, fun",
        icon_size = 64,
        effects = {
            { type = "unlock-recipe", recipe = "contained-uranium" }
        },
        prerequisites = {
            "logistic-science-pack",
    ...
    },
    {
        ...
        prerequisites = { "chemical-science-pack", "concrete", "centrifuge-tech" },
        unit =
        {
            ingredients =
            {
