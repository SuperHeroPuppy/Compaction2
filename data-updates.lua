...
data.raw.technology["rocket-control-unit"].prerequisites = {"utility-science-pack", "speed-module", "uranium-processing", "kovarex-enrichment-process", "contained-uranium-tech"}
